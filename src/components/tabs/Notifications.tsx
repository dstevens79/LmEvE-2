...
const notificationEvents: NotificationEvent[] = [
  ...
  },
  {
    ...
    description: 'Project milestones and completions',
    icon: Archive,
    category: 'operations'
  },
  {
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            {activeSubTab === 'discord' ? <CaretDown size={16} /> : <CaretRight size={16} />}
          </Button>
          ...
          >
            ...
            {activeSubTab === 'evemail' ? <CaretDown size={16} /> : <CaretRight size={16} />}
          </Button>
