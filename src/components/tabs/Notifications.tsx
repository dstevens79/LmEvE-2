            ...
            return (
              <div key={category} className="border border-border rounded-lg overflow-hidden">
                ...
                <div className="bg-card/50">
                  {/* Header Row */}
                  <div className="grid grid-cols-[1fr,auto,auto,auto] gap-4 px-4 py-2 border-b border-border bg-muted/20">
                  ...
                  {events.map((event) => {
                    ...
                    return (
                      <div 
                        key={event.id}
                        className="grid grid-cols-[1fr,auto,auto,auto] gap-4 px-4 py-3 border-b border-border last:border-b-0 hover:bg-muted/20 items-center"
                      >
