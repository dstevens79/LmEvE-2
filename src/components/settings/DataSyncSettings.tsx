  ...
  const [syncProcesses, setSyncProcesses] = useState<SyncProcess[]>([
    {
      ...
      icon: Users,
      enabled: syncSettings.corporation_members?.enabled ?? true,
      interval: syncSettings.corporation_members?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
    ...
    },
    {
      ...
      icon: Package,
      enabled: syncSettings.corporation_assets?.enabled ?? true,
      interval: syncSettings.corporation_assets?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1', 'v2'],
    ...
    },
    {
      ...
      icon: Factory,
      enabled: syncSettings.industry_jobs?.enabled ?? true,
      interval: syncSettings.industry_jobs?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
    ...
    },
    {
      ...
      icon: HardHat,
      enabled: syncSettings.mining_ledger?.enabled ?? false,
      interval: syncSettings.mining_ledger?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
    ...
    },
    {
      ...
      icon: TrendUp,
      enabled: syncSettings.market_orders?.enabled ?? false,
      interval: syncSettings.market_orders?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1', 'v2'],
    ...
    },
    {
      ...
      icon: CurrencyDollar,
      enabled: syncSettings.corporation_wallets?.enabled ?? true,
      interval: syncSettings.corporation_wallets?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
    ...
    },
    {
      ...
      icon: FileText,
      enabled: syncSettings.corporation_contracts?.enabled ?? true,
      interval: syncSettings.corporation_contracts?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
    ...
    },
    {
      ...
      icon: Receipt,
      enabled: syncSettings.item_pricing?.enabled ?? true,
      interval: syncSettings.item_pricing?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
    ...
    },
    {
      ...
      icon: Planet,
      enabled: syncSettings.planetary_interaction?.enabled ?? false,
      interval: syncSettings.planetary_interaction?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
    ...
    },
    {
      ...
      icon: User,
      enabled: syncSettings.personal_esi?.enabled ?? false,
      interval: syncSettings.personal_esi?.interval ?? 1440,
      lastSync: null,
      status: 'idle',
      currentVersion: 'v1',
      availableVersions: ['v1'],
