...
export type TabType = 'dashboard' | 'members' | 'assets' | 'manufacturing' | 'mining' | 'planetary' | 'logistics' | 'killmails' | 'market' | 'income' | 'notifications' | 'corporations' | 'theme' | 'settings';
