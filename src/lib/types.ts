...
export type TabType = 'dashboard' | 'members' | 'assets' | 'manufacturing' | 'mining' | 'planetary' | 'projects' | 'logistics' | 'killmails' | 'market' | 'income' | 'notifications' | 'corporations' | 'theme' | 'settings';
